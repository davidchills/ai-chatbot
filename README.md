I wanted to make an interface that used the OpenAI API. I used Laravel and VueJS and it came out pretty good. I'm not posting the actual app, because I'm sure someone will run my tokens out real quick.
